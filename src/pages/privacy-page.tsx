                ...
                <div className="rounded-3xl border border-white/40 bg-white/70 p-8 shadow-xl backdrop-blur md:p-12">
                    ...
                    <div className="mt-8 space-y-6 text-slate-700 leading-relaxed">
                        <section>
                            ...
                            <p>AI Tool Library(이하 "서비스")는 서비스 이용 과정에서 다음과 같은 정보를 자동으로 수집할 수 있습니다.</p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold">2. 개인정보의 수집 및 이용 목적</h2>
                            <ul className="ml-5 mt-2 list-disc space-y-1">
                        ...
                        <section>
                            ...
                            <p>이용자의 개인정보는 서비스 이용 기간 동안 보유하며, 회원 탈퇴 또는 수집 목적 달성 시 즉시 파기합니다. 단, 관련 법령에 의해 보존이 필요한 경우 해당 기간 동안 보관합니다.</p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>본 서비스는 Google AdSense 및 Google Analytics를 사용하며, 이를 위해 쿠키가 사용될 수 있습니다. 이용자는 브라우저 설정을 통해 쿠키 수집을 거부할 수 있으나, 이 경우 일부 서비스 이용에 제한이 있을 수 있습니다.</p>
                        </section>
